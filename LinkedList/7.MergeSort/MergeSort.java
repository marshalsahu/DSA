public class MergeSort {
    ...
    public static class LinkedListProgram{
        ...
        private  LinkedListProgram mergeSort(Node head , Node tail){

            if(head == tail){
                LinkedListProgram llist = new LinkedListProgram();
                llist.addLast(head.data);
                return llist;
            }

            Node midNode = getMidNode(head,tail);
            LinkedListProgram firstSortedHalf = mergeSort(head, midNode);
            LinkedListProgram secondSortedHalf = mergeSort(midNode.next, tail);
            LinkedListProgram completedList = LinkedListProgram.mergeTwoSortedLinkedList(firstSortedHalf, secondSortedHalf);
            return completedList;

        }
        
        public LinkedListProgram mergeSortCaller(){
    ...
    public static void main(String[] args) {
      ...
      llist.addFirst(523);
      llist.display();
      LinkedListProgram result = llist.mergeSortCaller();
      result.display();

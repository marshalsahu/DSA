    ...
    public static class LinkedListProgram{
        ...
        public void removeDuplcates(){
            ...
            while( this.size() > 0){
                ...
                if( llist.size == 0 || llist.getLast() != val){
                    llist.addLast(val);
                }
            }
            ...
            this.size = llist.size;

            //can't do this = llist becoz, this var is readable only
        }

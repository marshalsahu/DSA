public class KReverseInLinkedList {
    ...
    public static class LinkedListProgram{
        ...
        public void kReverse(int k){
            ...
            LinkedListProgram prev = null;

            while(this.size > 0){

                LinkedListProgram curr = new LinkedListProgram();
            ...
            this.tail = prev.tail;
            this.size = prev.size;
            //time complexity is linear : O(n) : outside loop runs for n/k times. and inner loop runs k times
        }

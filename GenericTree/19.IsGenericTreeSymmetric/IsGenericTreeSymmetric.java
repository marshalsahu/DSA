...
public class IsGenericTreeSymmetric {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isGenericTreeSymmetric(root));
    }
    ...
    //if tree is a mirror shape to itself, then tree is symmetric
    public static boolean isGenericTreeSymmetric(Node n1){
        return areTreeMirror(n1, n1);
    }
}
